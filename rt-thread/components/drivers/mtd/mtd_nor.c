...
{
    struct rt_mtd_nor_device *mtd_dev = (struct rt_mtd_nor_device *)dev;
    struct rt_device_blk_geometry *blk_geometry = (struct rt_device_blk_geometry *)args;
    switch (cmd)
    {
    case RT_DEVICE_CTRL_BLK_GETGEOME:
        blk_geometry->block_size = mtd_dev->block_size;
        break;
    default:
        break;
    }
