/*
 * @Author: Hello
 * @Date: 2021-01-21 17:44:43
 * @LastEditors: Hello
 * @LastEditTime: 2021-01-21 18:20:22
 * @FilePath: \Threadx_to_rt-thread\port\ux_device_cdc_acm.h
 */
...
#include "ux_device_class_cdc_acm.h"
  ...
  void usbx_cdc_acm_read_thread_entry(void *arg);
  void usbx_cdc_acm_write_thread_entry(void *arg);
