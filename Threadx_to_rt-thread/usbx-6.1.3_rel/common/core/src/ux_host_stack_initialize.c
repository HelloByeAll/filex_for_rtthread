...
UCHAR       *memory;
    ...
    if (_ux_system_host -> ux_system_host_enum_thread.name[0] != 0)
        _ux_utility_thread_delete(&_ux_system_host -> ux_system_host_enum_thread);
    
    /* Delete _ux_system_host -> ux_system_host_hcd_semaphore.  */
    if (_ux_system_host -> ux_system_host_hcd_semaphore.parent.parent.name[0] != 0)
    ...
    if (_ux_system_host -> ux_system_host_enum_semaphore.parent.parent.name[0] != 0)
